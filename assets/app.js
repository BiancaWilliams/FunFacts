...
function gifDisplay() {
  ...
  url = 'https://newsapi.org/v2/top-headlines?sources=msnbc&apiKey=fe5d1157918b42018d8a665c5f6b1a06';
}
...
/*
// the .on("click") function will start the AJAX call
$(".newsSearch").on("click", function(event) {

    //getting the text from the search box
    var news = $(".form-group").val();
 ...
 */
  ...
  /*
    ...
    var searchTerm = $("newsSearch").val().trim();
